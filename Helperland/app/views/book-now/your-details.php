<div class="your_details">
    ...
    <div>
        ...
        <div id="favourite_sp_container">
            <!-- FAVORITE SP CARD GENERATED BY JAVASCRIPT -->
        </div>
    </div>
    <div class="validation_message d_none">
        <p>Validation Message</p>
...
<script>
        ...
        $.ajax({
            ...
            success : function(res){
                if(res!=="" && res!==undefined){
                    try{
                        const result = JSON.parse(res);
                        service_request.all_address = result.address;
                        $('#user_radio_address_container').html(`${(function(){    
                            let html = '';
                            service_request.all_address.forEach((i)=>{
                                html += `
    ...
    $('#your_details_submit_btn').click(function(){
        ...
        if(validation){
            ...
            service_request.all_address.filter((obj)=>{
            ...
            if($('[name="favourite_sp"]:checked').val()!==""){
                service_request.sp_id = parseInt($('[name="favourite_sp"]:checked').val());
            }
            else{
