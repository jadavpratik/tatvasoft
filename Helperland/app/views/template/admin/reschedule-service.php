...
<body>
    <div style="padding:10px 15px;border-radius:4px;border:0.5px solid lightgray;">
        <p style="padding:8px 0; text-align:center; font-size:14px;font-weight:bold;color:#4f4f4f">Your service has been rescheduled by admin</p>
        <p style="padding:8px 0; text-align:center; font-size:14px;font-weight:bold;color:#4f4f4f">Details Mentioned below</p>
        <!-- CUSTOMER INFO -->
