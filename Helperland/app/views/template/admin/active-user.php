...
<body>
    <div style="padding:40px 15px 10px;border-radius:4px;border:0.5px solid lightgray;">
        <p style="padding:4px 0;text-align:center;font-size:14px;font-weight:bold;color:#4f4f4f">Thank you for your patience, your account has been actived by admin.</p>
        <br>
